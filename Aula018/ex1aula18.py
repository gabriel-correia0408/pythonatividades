...
print(lista[::-1])
print(f'{lista[6]}, {lista[5]}, {lista[5]}, {lista[4]}, {lista[3]}, {lista[2]}, {lista[1]}, {lista[0]}' '\n')
########################################################################################################
print('='*50)
...
print(f'{lista[5]} é muito bom, sinto muito {lista[2]} quando chupo {lista[4]} deles.''\n')
#####################################################################################################
print('='*50)
...
#######################################################################################################
print(f'{lista[0]} - {lista[2]} - {lista[6]}''\n')
...
#########################################################################################################
print(f'{lista[5]} - {lista[3]} - {lista[6]} - {lista[1]} - {lista[4]} ''\n')
...
print(f'{lista[10]} - {lista[3]} - {lista[6]}')

print('='*50)

#lista '-' da o ultimo elemento que a dentro da lista +