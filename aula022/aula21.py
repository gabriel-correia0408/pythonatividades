...
class Pessoa:
    ...
    '''
    def __init__ (self,nome1,cpf1,data_de_nascimento1,altura1,salario1,endereço1):#o __init__ é o nosso motor de partida
        ''' 
        ...
        '''
        ################################ Atributos
        #temos que criar uma varivél no self,para receber as primerias varivesis criadas 
        # e seus rspctivos(elementos,e valorscontidos nelas)
        self.nome = nome1
        self.cpf = cpf1
        ...
        ############################### Atributos de estado
        # Estado da pessoa
        self.fome = None# none significa nada por enquanto
        self.sede = None
        self.exausta = None

    
    def correr(self,distancia):#Criando metodos
        '''
