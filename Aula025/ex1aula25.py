...
class Cliente:
    def __init__(self,codigo1, nome1, idade1, telefone1, email1, endereco1):
        ...
        self.nome1 = nome
        self.idade1  = idade
        self.telefone1 = telefone 
        self.email1 = email
        self.endereco1  =  endereco
        self.credito = None
        self.saldo = None
    ...
    def atualizar (self):
        ...
        '''
        self.codigo = int(input('Digite o código cliente: '))
        self.nome = input('Digite o nome nome cliente: ')
        self.idade = int(input('Digite a idade cliente: '))
        self.telefone = input('Digite o telefone: ')
        self.email = input('Digite o emial: ')
